 ...
 * @internal
 */
export const defaultRekognitionStreamingHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(
  authParameters: RekognitionStreamingHttpAuthSchemeParameters
): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: RekognitionStreamingClientConfig, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultRekognitionStreamingHttpAuthSchemeProvider: RekognitionStreamingHttpAuthSchemeProvider = (
  authParameters
) => {
