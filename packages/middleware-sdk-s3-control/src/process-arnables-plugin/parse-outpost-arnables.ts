...
import { EndpointV2, InitializeHandlerOptions, InitializeMiddleware } from "@smithy/types";
...
export interface ParseOutpostArnablesMiddlewareHandlerExecutionContext {
  /**
 ...
 * region.
 */
export const parseOutpostArnablesMiddleware =
  (options: S3ControlResolvedConfig): InitializeMiddleware<ArnableInput, any> =>
    (next, context: ParseOutpostArnablesMiddlewareHandlerExecutionContext) =>
      async (args) => {
        const { input } = args;
 ...
 * @deprecated
 */
export const parseOutpostArnablesMiddleaware = parseOutpostArnablesMiddleware;

export const parseOutpostArnablesMiddlewareOptions: InitializeHandlerOptions = {
  step: "initialize",
 ...
 * @deprecated
 */
export const parseOutpostArnablesMiddleawareOptions = parseOutpostArnablesMiddlewareOptions;
