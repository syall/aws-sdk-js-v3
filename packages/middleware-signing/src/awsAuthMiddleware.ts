...
export interface AwsAuthMiddlewareHandlerExecutionContext {
  /**
...
export const awsAuthMiddleware =
  <Input extends object, Output extends object>(
    ...
    (next: FinalizeHandler<Input, Output>, context: AwsAuthMiddlewareHandlerExecutionContext): FinalizeHandler<Input, Output> =>
