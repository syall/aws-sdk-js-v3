 ...
 * @internal
 */
export interface TokenMiddlewareHandlerExecutionContext {
  /**
...
export const tokenMiddleware =
  <Input extends object, Output extends object>(
    ...
    (next: FinalizeHandler<Input, Output>, context: TokenMiddlewareHandlerExecutionContext): FinalizeHandler<Input, Output> =>
